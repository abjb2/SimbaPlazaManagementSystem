        ...
        <div class="row ml-4">
            <div class="col-md-4 bg-light rounded p-4 mr-5">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <input type="submit" name="btn_delete" value="DELETE ROOM" class="btn-sm btn-danger">
                    </div>
                </form>
                <?php
                ...
                if(isset($_POST['btn_delete']))
                {
                    ...
                    {
                        $deleteRoom = "DELETE FROM `rooms` WHERE room_type = '$roomtype' AND room_floor = '$floor'";
                        if(mysqli_query($db_connection, $deleteRoom))
                        {
                            echo '<script type="text/javascript">alert("Room Deleted") </script>';

                        }else {
                            echo '<script type="text/javascript">alert("Sorry ! Check The System") </script>' ;
                        }
                    }
                }
                ?>
